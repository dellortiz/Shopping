...
<ul id="menu">
    ...
    <!-- <ul>
        <li class="section-menu-li "><a href="clothes.php">Clothes</a></li>
        <li class="section-menu-li up"><a href="shoes.php">Shoes</a></li>
        <li class="section-menu-li "><a href="hats.php">Hats</a></li>
        </ul> -->
</section>
<div class="div-main">
...
<!-- <input class="botton-buy" type="submit" value="Add to Basket" onclick="addToBasket(<?= htmlspecialchars(json_encode($product)) ?>)"> -->
