...
<?php
        ...
        try {
            ...
            $sql = "SELECT * FROM products WHERE category = 'hats'";
            ...
            if ($selectedPrice !== 'all' && $selectedPrice !== '') {
                if ($selectedPrice === 'first') {
                    ...
                    $sql .= " AND price >= 50 AND price <= 200";
                }
            }
    ...
    <section>
        <div class="div-main-img">
            <img src="./asset/sombrerohombre.jpeg" alt="">
            <img src="./asset/tienda.jpeg" alt="Imagen 2">
            <img src="./asset/sombreromujer.jpeg" alt="Imagen 1">
        </div>
        <div class="div-main-img-botton">
            <form method="GET" action="">
                ...
                <select name="genre" onchange="this.form.submit()">
                    ...
                    <option value="woman" <?= $selectedGenre == 'woman' ? 'selected' : '' ?>>Woman</option>
                    <option value="man" <?= $selectedGenre == 'man' ? 'selected' : '' ?>>Man</option>
                    <option value="unisex" <?= $selectedGenre == 'unisex' ? 'selected' : '' ?>>Unisex</option>
                </select>
                <!-- Select para precio -->
