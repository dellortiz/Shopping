...
<main class="main-body-index">
    <section class="select-menu" id="menu-desktop">
        <ul id="menu">
            ...
            <li class="section-menu-li up">Phones
                <ul class="submenu">
    ...
    try {
      ...
      $sql = "SELECT * FROM products WHERE category = 'android'";
  ...
  <section >
    <div class="div-main-img">
      <img src="./asset/hombreteléfono.jpeg" alt="">
      <img src="./asset/tiendatelefonos.jpeg" alt="Imagen 2">
      <img src="./asset/mujerteléfono.jpeg" alt="Imagen 1">
    </div>
    <div class="div-main-img-botton">
      <form method="GET" action="">
        ...
        <select name="genre" onchange="this.form.submit()">
          ...
          <option value="low range" <?= $selectedGenre == 'low range' ? 'selected' : '' ?>>Low range</option>
          <option value="mid range" <?= $selectedGenre == 'mid range' ? 'selected' : '' ?>>Mid range</option>
          <option value="high range" <?= $selectedGenre == 'high range' ? 'selected' : '' ?>>High range</option>
        </select>
        <!-- Select para precio -->
